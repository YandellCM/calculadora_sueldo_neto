import reflex as rx  # Librería principal

# Porcentajes  
tss = 0.0591  # Seguridad Social
isr = 0.15    # Impuesto Sobre la Renta
bono = 0.10   # Bonificación

# Estado de la aplicación tales como datos y lógica 
...
def vista():
    return rx.center(
        rx.vstack(
            rx.heading("Calculadora de Sueldo Neto", size="lg"),
